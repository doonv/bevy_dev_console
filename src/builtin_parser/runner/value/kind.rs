...
impl ValueKind {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::AnyUnsignedInteger => "unsigned integer",
            Self::AnySignedInteger => "signed integer",
            Self::AnyFloat => "float",
    ...
    pub const fn as_natural(self) -> &'static str {
        match self {
            ...
            Self::AnyUnsignedInteger => "any unsigned integer",
            Self::AnySignedInteger => "any signed integer",
